			...
			<main class="flex-shrink-0">
			  ...
			  <div class='card' >
				    <div class='card-header' style="background-color: #08082b;">
				        <h5 class="text-info">Aggiorna annuncio</h5> 
				    </div>
				    <div class='card-body'>
							...
							<form:form modelAttribute="edit_annuncio_attr" method="post" action="${pageContext.request.contextPath}/annuncio/update" novalidate="novalidate" class="row g-3">
								...
								<div class="col-md-6">
									...
									<spring:bind path="testoAnnuncio">
										<input type="text" name="testoAnnuncio" id="testoAnnuncio" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire la descrizione" value="${edit_annuncio_attr.testoAnnuncio }" required>
									</spring:bind>
								...
								<div class="col-md-6">
									...
									<spring:bind path="prezzo">
										<input type="text" name="prezzo" id="prezzo" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il prezzo" value="${edit_annuncio_attr.prezzo }" required>
									</spring:bind>
									<form:errors  path="prezzo" cssClass="error_field" />
								</div>

								<div class="col-md-6">
									<input type="hidden" name="data" id="data" class="form-control ${status.error ? 'is-invalid' : ''}" value="${edit_annuncio_attr.data }" required>
								</div>
